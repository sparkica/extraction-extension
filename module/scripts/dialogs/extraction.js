...
ExtractionDialog.prototype = {
  init: function (callback) {
    var self = this,
        selectedServices = {},
        dialogElement = this.dialogElement = $(DOM.loadHTML("extraction-extension", "scripts/dialogs/extraction.html"));
    ...
    $.getJSON(ExtractionExtension.servicesPath, function (services) {
